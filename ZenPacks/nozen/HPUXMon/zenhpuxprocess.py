...
class zenhpuxprocess(SnmpDaemon):
    ...
    statusEvent = { 'eventClass' : Status_OSProcess,
                    'eventGroup' : 'Process' }
    initialServices = SnmpDaemon.initialServices + ['ZenPacks.skills1st.bridge.HPUXProcessConfig']
...
if __name__ == '__main__':
    ...
    from ZenPacks.skills1st.bridge.zenhpuxprocess import zenhpuxprocess
    z = zenhpuxprocess()
    z.run()
